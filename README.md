선생님, 요청하신 범위는 에듀테크 제품 전체 기획서+엔지니어링 문서 풀세트에 해당합니다.
전남미래국제학교 학생들의 특성과, 선생님이 구현하고자 하는 “완성형 통합 AI 한국어 학습 시스템”을 기준으로
아래 항목을 모두 포함한 1차 버전 전체 문서를 완성본 형태로 만들어드립니다.
...
전부 아래에 상세히 정리합니다.
(필요하면 PDF/Notion 형태 템플릿도 만들어드릴 수 있습니다.)
